	...
	public static class FormSerialisor
	{
		...
		private static void AddChildControls(XmlTextWriter xmlSerialisedForm, Control c)
		{
			foreach (Control childCtrl in c.Controls)
			{
				...
				else if (childCtrl is Label)
					xmlSerialisedForm.WriteElementString("Text", ((Label)childCtrl).Text);
				else if (childCtrl is Button)
					xmlSerialisedForm.WriteElementString("Text", ((Button)childCtrl).Text);
				else if (childCtrl is GroupBox)
					xmlSerialisedForm.WriteElementString("Text", ((GroupBox)childCtrl).Text);
					...
					if (ctrlToSet.GetType().ToString() == controlType)
					{
						...
						switch (controlType)
						{
							...
							case "System.Windows.Forms.GroupBox":
								((System.Windows.Forms.GroupBox)ctrlToSet).Text = n["Text"].InnerText;
								break;
							case "System.Windows.Forms.Label":
								((System.Windows.Forms.Label)ctrlToSet).Text = n["Text"].InnerText;
								break;
